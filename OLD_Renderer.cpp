...
//	&vulkanDevice
//);
//VulkanModuleDeviceMemoryImage depthBufferMemory(VkMemoryPropertyFlagBits::VK_MMORY_PROPERTY_DEVICE_LOCAL_BIT, &vulkanPhysicalDevice, &vulkanDevice, &vulkanDepthBufferImage); //We need to explicitly give the depth buffer memory, but not the swap chain images as they already have memory from the swap chain
//
//// Image views
...
//// Vertex Data
//VulkanVertexData<VulkanVertexAttributePos> vertexData; // #TODO_OLD: Instead of passing this in, make a VulkanModuleVertedBuffer that derrives from VulkanModuleBuffer and has a GetVertexData() thing"
//
///// IMGUI
...
//#endif //~ #ifdef DOMIMGUI
//
//	// #TODO_OLD: This should use semaphores and that
