...
EditorTypePropertyStruct::EditorTypePropertyStruct()
{
...
void EditorTypePropertyStruct::ReadFromFile(std::ifstream& file)
{
	...
	if (!pStructType) // Struct type might already be set if this struct property was deep copied from a template type.
	{
